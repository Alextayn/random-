...
#             try:
#                 data = json.load(f)
#                 # Проверяем, старый ли формат (пароли хранятся как строки)
...
#                 "password": "1234",
#                 "classes": {"10А": [
#                     {"name": "Смирнов Алексей", "grades": 0, "selected": False, "last_round": 0}
#                 ]},
#                 "round_counter": 0
#             }
#         }
...
#
# # 4. Окно со списком учеников (С КНОПКАМИ ВНИЗУ И СКРОЛЛОМ)
...
#
#     # === 1. Область с прокруткой для списка ===
...
#     draw_list()
#
#     # === 2. Фиксированные кнопки внизу окна ===
...
#
#
#             # final_weight = max(1, int(base_weight * history_coef))
...
#
#     # Кнопки теперь всегда видны внизу
